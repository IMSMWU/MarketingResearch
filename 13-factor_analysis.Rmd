...
```{r message=FALSE, warning=FALSE, eval=TRUE, echo=TRUE}
spotify_data <- read.csv("/home/felix/Dropbox/e-Assistant IMSM/course_daniel/music_data.csv", 
                          sep = ",", 
                          header = TRUE) #read in data
#spotify_data <- na.omit(spotify_data[16:27])
spotify_data <- na.omit(spotify_data[,c(5,16:27,31,37,42,44)])
```
...
```{r message=FALSE, warning=FALSE, eval=TRUE, echo=TRUE}
pc1 <- principal(spotify_data, nfactors = 12, rotate = "none")
pc1
```
...
```{r message=FALSE, warning=FALSE, eval=TRUE, echo=TRUE}
pc2 <- principal(spotify_data, nfactors = 4, rotate = "none")
pc2
```
...
```{r message=FALSE, warning=FALSE, eval=TRUE, echo=TRUE}
pc3 <- principal(spotify_data, nfactors = 4, rotate = "varimax")
pc3
```
...
```{r message=FALSE, warning=FALSE, eval=TRUE, echo=TRUE}
pc4 <- principal(spotify_data, nfactors = 4, rotate = "oblimin", scores = TRUE)
